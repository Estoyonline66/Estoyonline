    ...
    <>
      <section className="w-full flex flex-col gap-5 py-20 px-5 md:px-20 lg:px-40 z-0">
        <ul className="grid grid-cols-1 sm:grid-cols-3 gap-10">
            ...
            <li
                key={index}
                className="bg-[#F8BC1680] rounded-lg text-[#333] p-6 h-[200px] text-center  shadow-lg scale-100 duration-300 hover:scale-105"
            >
                <h1 className="text-2xl font-semibold h-[2.5rem] overflow-hidden break-words">{card.title}</h1>
                <p className="text-sm">
