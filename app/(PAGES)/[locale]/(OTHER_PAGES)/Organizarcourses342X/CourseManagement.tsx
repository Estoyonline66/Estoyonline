...
const hoursEn = Array.from({ length: 48 }, (_, i) => {
  let hour = 5 + Math.floor(i / 2); // 5:00 am başlangıç
...
const hoursTr = Array.from({ length: (22 - 9 + 1) * 2 }, (_, i) => {
