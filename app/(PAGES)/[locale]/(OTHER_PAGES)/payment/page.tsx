...
export default function ResultsPage() {
  ...
  // Eğer parametrede "_" varsa, başlık kısmını ayır
  const courseBase = courseParam ? courseParam.split("_")[0] : null;

  // Course -> Stripe Link eşleştirmesi (anahtarlı)
  ...
  const handleContinue = () => {
    ...
    if (courseParam && courseLinks[courseParam]) {
      // Orijinal linki al
  ...
  return (
    <div className="container mx-auto p-6">
      {courseBase && <h2 className="text-lg font-semibold mb-2">{courseBase}</h2>}
